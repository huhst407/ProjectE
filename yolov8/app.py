...
def main():
    serve(app, host='http://127.0.0.1/', port=5000)
...
yolo_classes = ['TC', 'abnormal', 'fibrocollagenous tissue', 'fibromuscular tissue', 'inflammatory cell', 'lymphoid', 'normal', 'rbc', 'stroma']
